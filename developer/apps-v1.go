...
func GetSecrets(appkey string, params *GetSecretsParams) (*GetSecretsResponse, error) {
    resp, err := saxo.GetClient().DoRequest("GET", "https://gateway.saxobank.com/sim/openapi/developer/apps/{AppKey}/secrets/?$top={$top}&$skip={$skip}&$inlinecount={$inlinecount}", nil) 
    if err != nil {
        return nil, err
...
func GetSecretById(appkey string, secretid string) ([]byte, error) {
    resp, err := saxo.GetClient().DoRequest("GET", "https://gateway.saxobank.com/sim/openapi/developer/apps/{AppKey}/secrets/{SecretId}", nil) 
    if err != nil {
        return nil, err
    } else if sc := resp.Response().StatusCode; sc >= 300 {
		return nil, fmt.Errorf("unexpected status code %d", sc)
...
func CreateSecret(appkey string, params *CreateSecretParams) (*CreateSecretResponse, error) {
    resp, err := saxo.GetClient().DoRequest("POST", "https://gateway.saxobank.com/sim/openapi/developer/apps/{AppKey}/secrets", nil) 
    if err != nil {
        return nil, err
    } else if sc := resp.Response().StatusCode; sc >= 300 {
		return nil, fmt.Errorf("unexpected status code %d", sc)
...
func UpdateSecret(appkey string, secretid string, params *UpdateSecretParams) (*UpdateSecretResponse, error) {
    resp, err := saxo.GetClient().DoRequest("PATCH", "https://gateway.saxobank.com/sim/openapi/developer/apps/{AppKey}/secrets/{SecretId}", nil) 
    if err != nil {
        return nil, err
    } else if sc := resp.Response().StatusCode; sc >= 300 {
		return nil, fmt.Errorf("unexpected status code %d", sc)
...
func DeleteSecret(appkey string, secretid string) ([]byte, error) {
    resp, err := saxo.GetClient().DoRequest("DELETE", "https://gateway.saxobank.com/sim/openapi/developer/apps/{AppKey}/secrets/{SecretId}", nil) 
    if err != nil {
        return nil, err
    } else if sc := resp.Response().StatusCode; sc >= 300 {
		return nil, fmt.Errorf("unexpected status code %d", sc)
...
func GetRedirectUris(appkey string, params *GetRedirectUrisParams) (*GetRedirectUrisResponse, error) {
    resp, err := saxo.GetClient().DoRequest("GET", "https://gateway.saxobank.com/sim/openapi/developer/apps/{AppKey}/redirecturis/?$top={$top}&$skip={$skip}&$inlinecount={$inlinecount}", nil) 
    if err != nil {
        return nil, err
    } else if sc := resp.Response().StatusCode; sc >= 300 {
		return nil, fmt.Errorf("unexpected status code %d", sc)
...
func GetRedirectUriFromId(appkey string, redirecturiid string, params *GetRedirectUriFromIdParams) (*GetRedirectUriFromIdResponse, error) {
    resp, err := saxo.GetClient().DoRequest("GET", "https://gateway.saxobank.com/sim/openapi/developer/apps/{AppKey}/redirecturis/{RedirectUriId}/?$top={$top}&$skip={$skip}&$skiptoken={$skiptoken}&$inlinecount={$inlinecount}", nil) 
    if err != nil {
        return nil, err
    } else if sc := resp.Response().StatusCode; sc >= 300 {
		return nil, fmt.Errorf("unexpected status code %d", sc)
...
func UpdateRedirectUri(appkey string, redirecturiid string, params *UpdateRedirectUriParams) (*UpdateRedirectUriResponse, error) {
    resp, err := saxo.GetClient().DoRequest("PATCH", "https://gateway.saxobank.com/sim/openapi/developer/apps/{AppKey}/redirecturis/{RedirectUriId}", nil) 
    if err != nil {
        return nil, err
    } else if sc := resp.Response().StatusCode; sc >= 300 {
		return nil, fmt.Errorf("unexpected status code %d", sc)
...
func DeleteRedirectUri(appkey string, redirecturiid string) ([]byte, error) {
    resp, err := saxo.GetClient().DoRequest("DELETE", "https://gateway.saxobank.com/sim/openapi/developer/apps/{AppKey}/redirecturis/{RedirectUriId}", nil) 
    if err != nil {
        return nil, err
    } else if sc := resp.Response().StatusCode; sc >= 300 {
		return nil, fmt.Errorf("unexpected status code %d", sc)
...
func CreateRedirectUri(appkey string, params *CreateRedirectUriParams) (*CreateRedirectUriResponse, error) {
    resp, err := saxo.GetClient().DoRequest("POST", "https://gateway.saxobank.com/sim/openapi/developer/apps/{AppKey}/redirecturis", nil) 
    if err != nil {
        return nil, err
    } else if sc := resp.Response().StatusCode; sc >= 300 {
		return nil, fmt.Errorf("unexpected status code %d", sc)
...
func GetApps(params *GetAppsParams) (*GetAppsResponse, error) {
    resp, err := saxo.GetClient().DoRequest("GET", "https://gateway.saxobank.com/sim/openapi/developer/apps/?$top={$top}&$skip={$skip}&$inlinecount={$inlinecount}", nil) 
    if err != nil {
        return nil, err
    } else if sc := resp.Response().StatusCode; sc >= 300 {
		return nil, fmt.Errorf("unexpected status code %d", sc)
...
func GetAppByAppKey(appkey string) (*GetAppByAppKeyResponse, error) {
    resp, err := saxo.GetClient().DoRequest("GET", "https://gateway.saxobank.com/sim/openapi/developer/apps/{AppKey}", nil) 
    if err != nil {
        return nil, err
    } else if sc := resp.Response().StatusCode; sc >= 300 {
		return nil, fmt.Errorf("unexpected status code %d", sc)
...
func GetResourceByAppKey(appkey string) (*GetResourceByAppKeyResponse, error) {
    resp, err := saxo.GetClient().DoRequest("GET", "https://gateway.saxobank.com/sim/openapi/developer/apps/resource/{AppKey}", nil) 
    if err != nil {
        return nil, err
    } else if sc := resp.Response().StatusCode; sc >= 300 {
		return nil, fmt.Errorf("unexpected status code %d", sc)
...
func CreateApp(params *CreateAppParams) (*CreateAppResponse, error) {
    resp, err := saxo.GetClient().DoRequest("POST", "https://gateway.saxobank.com/sim/openapi/developer/apps", nil) 
    if err != nil {
        return nil, err
    } else if sc := resp.Response().StatusCode; sc >= 300 {
		return nil, fmt.Errorf("unexpected status code %d", sc)
...
func UpdateApp(appkey string, params *UpdateAppParams) ([]byte, error) {
    resp, err := saxo.GetClient().DoRequest("PATCH", "https://gateway.saxobank.com/sim/openapi/developer/apps/{AppKey}", nil) 
    if err != nil {
        return nil, err
    } else if sc := resp.Response().StatusCode; sc >= 300 {
		return nil, fmt.Errorf("unexpected status code %d", sc)
...
func DeactivateApp(appkey string) ([]byte, error) {
    resp, err := saxo.GetClient().DoRequest("DELETE", "https://gateway.saxobank.com/sim/openapi/developer/apps/{AppKey}", nil) 
    if err != nil {
        return nil, err
    } else if sc := resp.Response().StatusCode; sc >= 300 {
		return nil, fmt.Errorf("unexpected status code %d", sc)
